...
export const getExamById = async (req, res) => {
  try {
    ...
    // Validate that examId is a valid MongoDB ObjectId
    ...
    // Find the exam and populate related data if needed
    const exam = await Exam.findById(examId)
      .populate('createdBy', 'name email') // Populate createdBy with user name and email
      .populate('userId', 'name email'); // Populate userId with user name and email
